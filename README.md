# Домашнее задание к занятию 5. «Практическое применение Docker» "Макарцев Александр Владимирович"
...
#!/bin/bash
cd /opt
git clone https://github.com/MakarAlexander/05-04-hw-devops.git
cd 05-04-hw-devops
docker compose up -d
```
...
```
Извлекаем к себе на машину все слои образа и через tar разархивируем данные из нужного нам слоя.
